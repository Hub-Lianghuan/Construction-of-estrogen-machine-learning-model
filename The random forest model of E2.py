...
# 1. 加载数据
data = pd.read_excel(r"C:\Users\LiangHuan\Desktop\特征数据2.xls", sheet_name='E2')
...
# 10. 保存模型和标准化器
dump(multioutput_model, r'C:\Users\LiangHuan\Desktop\全部\E2\best_model.joblib')  # 保存训练好的模型
dump(scaler_X, r'C:\Users\LiangHuan\Desktop\全部\E2\scaler_X.joblib')  # 保存输入特征的标准化器
dump(scaler_y, r'C:\Users\LiangHuan\Desktop\全部\E2\scaler_y.joblib')  # 保存目标变量的标准化器
