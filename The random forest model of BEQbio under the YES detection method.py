...
# 1. 加载数据
data = pd.read_excel(r"C:\Users\LiangHuan\Desktop\原始数据、特征数据\特征数据2.xls", sheet_name='BEQbio-yes')
x = data.iloc[:, 4:12]  # 选择特征列
y = data.iloc[:, -2]
...
# 10. 保存模型和标准化器
dump(multioutput_model, r'C:\Users\LiangHuan\Desktop\全部\BEQbio-yes\best_model.joblib')  # 保存训练好的模型
dump(scaler_X, r'C:\Users\LiangHuan\Desktop\全部\BEQbio-yes\scaler_X.joblib')  # 保存输入特征的标准化器
dump(scaler_y, r'C:\Users\LiangHuan\Desktop\全部\BEQbio-yes\scaler_y.joblib')  # 保存目标变量的标准化器
